...
export default async function Command() {
  ...
  try {
    ...
    // Perform Google search with the refined query
...
async function refineSearchQuery(query: string, toast: Toast): Promise<string> {
  // const prompt = `Refine this Google search query to get the best results: "${query}". Only provide the refined query, nothing else.`;
